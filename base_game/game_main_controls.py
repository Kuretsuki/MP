...
def handle_movement(grid, x, y, i, j, held_items, previous_loc, current_mush, mushrooms, tile_under_rock, multi_move = False, silent = False):
    current_loc = (x, y)
    ...
    if not (0 <= next_x < len(grid) and 0 <= next_y < len(grid[next_x])):
        ...
        return (x, y), previous_loc, held_items, current_mush, None, pick_up_message, tile_under_rock
    ...
    if target_cell in [".", "_", "*", "x", "T"]:
        ...
        return (next_x, next_y), previous_loc, held_items, current_mush, None, pick_up_message, tile_under_rock
    ...
    # Pushing rocks
        ...
        return current_loc, previous_loc, held_items, current_mush, None, pick_up_message, tile_under_rock
    ...
    # Collecting mushrooms
        ...
        if current_mush == mushrooms:
            ...
            return current_loc, previous_loc, held_items, current_mush, True, pick_up_message, tile_under_rock
    ...
    # Falling in the water - Losing State
        ...
        return current_loc, previous_loc, held_items, current_mush, False, pick_up_message, tile_under_rock
